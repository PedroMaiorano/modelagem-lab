...
export default function PainelUpload({ aoPreparar }: Props) {
  ...
  if (!aberto) {
    return (
      <button
        ...
        className="w-full rounded-md border border-dashed border-slate-700 px-3 py-2 text-xs font-medium text-slate-400 transition hover:border-emerald-700 hover:text-emerald-400"
      >
  ...
  return (
    <div className="flex flex-col gap-3 rounded-md border border-slate-700 bg-slate-900 p-3">
      ...
      {!upload && (
        <label className="flex cursor-pointer flex-col items-center justify-center gap-1 rounded-md border border-dashed border-slate-700 px-3 py-6 text-center text-xs text-slate-500 hover:border-emerald-700 hover:text-emerald-400">
      ...
      {upload && (
        <>
          ...
          {modo === "amostra" && (
            <div className="flex flex-col gap-2 rounded-md border border-slate-800 p-2">
              <select
                ...
                className="w-full rounded-md bg-slate-800 border border-slate-700 px-2 py-1.5 text-xs text-slate-100"
              >
            ...
            <div className="flex flex-col gap-2 rounded-md border border-slate-800 p-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="w-20 rounded-md bg-slate-800 border border-slate-700 px-2 py-1 text-xs text-slate-100"
                />
                <button
                  onClick={() => void aoSugerirCorte()}
                  disabled={!colunaData}
                  className="rounded-md border border-slate-700 px-2 py-1 text-[11px] text-slate-300 hover:border-emerald-700 hover:text-emerald-400 disabled:opacity-40"
                >
                  sugerir corte
                </button>
              </div>
            ...
            <div className="flex items-center gap-2 rounded-md border border-slate-800 p-2">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-md bg-slate-800 border border-slate-700 px-2 py-1 text-xs text-slate-100"
                />
              </div>
              <div className="flex-1">
          ...
          <button
            ...
            className="w-full rounded-md bg-emerald-600 px-3 py-2 text-xs font-semibold text-white transition hover:bg-emerald-500 disabled:cursor-not-allowed disabled:bg-slate-700 disabled:text-slate-400"
          >
